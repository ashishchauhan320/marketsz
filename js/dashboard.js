...
jQuery(document).ready(function () {
    jQuery(".coupons-box a").click(function() {
        jQuery(this).parent().parent().remove();
        jQuery(".plan-pricing").addClass('show');
    });
...
/*function openNav() {
    ...
    document.getElementById("mySidenav").classList.add('MyClass');
}

function closeNav() {
    document.getElementById("mySidenav").style.width = "75px";
    document.getElementById("main").style.marginLeft= "75px";
    document.getElementById("mySidenav").classList.remove('MyClass');
}*/
